...
heading = Label(root, text='Ideal body mass index', fg='white',  bg="purple")
...
weight = Label(frame, text="Weight(kg):", bg='white', fg="purple")
weight.place(x=50, y=27)
weight_entry = Entry(frame)
weight_entry.place(x=200, y=27)

height = Label(frame, text="Height(cm):", bg='white', fg="purple")
height.place(x=50, y=60)
height_entry = Entry(frame)
height_entry.place(x=200, y=60)

gender = Label(frame, text="Gender:", bg='white', fg="purple")
gender.place(y=100, x=50)

age = Label(frame, text="Age:", bg='white', fg="purple")
age.place(y=150, x=50)
age_entry = Entry(frame, state='readonly')
age_entry.place(y=150, x=200)
